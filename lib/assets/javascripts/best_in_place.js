...
function BestInPlaceEditor(e) {
    ...
    jQuery(this.activator).bind('dblclick', {editor: this}, this.clickHandler);
}
...
BestInPlaceEditor.prototype = {
    ...
    activate: function () {
        ...
        jQuery(this.activator).unbind('dblclick', this.clickHandler);
        this.activateForm();
...
BestInPlaceEditor.forms = {
    "input": {
        activateForm: function () {
            ...
            if (this.cancelButton) {
                this.element.find("input[type='button']").bind('dblclick', {editor: this}, BestInPlaceEditor.forms.input.cancelButtonHandler);
            }
            if (!this.okButton) {
    ...
    "textarea": {
        activateForm: function () {
            ...
            if (this.cancelButton) {
                this.element.find("input[type='button']").bind('dblclick', {editor: this}, BestInPlaceEditor.forms.textarea.cancelButtonHandler);
            }
...
jQuery.fn.best_in_place = function () {
    ...
    jQuery(this.context).delegate(this.selector, 'dblclick', function () {
        var el = jQuery(this);
