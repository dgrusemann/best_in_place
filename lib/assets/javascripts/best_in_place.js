...
function BestInPlaceEditor(e) {
    ...
    jQuery(this.activator).bind(this.activatorEvent, {editor: this}, this.clickHandler);
}
...
BestInPlaceEditor.prototype = {
    ...
    activate: function () {
        ...
        jQuery(this.activator).unbind(this.activatorEvent, this.clickHandler);
        this.activateForm();
    ...
    initOptions: function () {
        ...
        self.activatorEvent = self.element.data("bipActivatorEvent") || 'click';
...
jQuery.fn.best_in_place = function () {
    ...
    jQuery(this.context).delegate(this.selector, this.activatorEvent, function () {
        var el = jQuery(this);
